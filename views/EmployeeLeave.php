                                        ...
                                        <?php $emp_que=mysqli_query($con,"SELECT * FROM emp_apply_leave ");
                                            $cnt = 1; while($emp=mysqli_fetch_assoc($emp_que)) { ?>
                                                <tr>
                                                   ...
                                                   <td>
                                                        <button type="button" class="btn btn-sm" data-toggle="modal" data-target="#updateDepartments" title="Edit" onclick="update_employee(`<?php echo $emp['id'];?>`,`<?php echo $emp['leave_from']?>`,`<?php echo $emp['leave_to'];?>`,`<?php echo $emp['leave_reason'];?>`,`<?php echo $emp['leave_type'];?>`,`<?php echo $emp['contact_num'];?>`,`<?php echo $emp['leave_purpose'];?>`,`<?php echo $emp['addressduring_leave'];?>`)"><i class="icon-pencil"></i></button>
...
<!-- Add employee modal -->
<div class="modal animated bounceIn" id="addDepartments" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel"><i class="icon-plus" ></i> Apply For leave</h6>
            </div>
            <form  action="apply-leave-employee" method="POST" name="addemployeeform"  >
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-4">
                            <div class="form-group option-width">
                                ...
                                <br />
                                <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $users['user_type']?>" readonly />
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $users['name']?>" required readonly name="emp_name"> 
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>Account Id</label>
                                <input type="text" class="form-control" value="<?php echo $users['emp_id']?>" required readonly name="emp_id">
                            </div>
                        </div>
                                ...
                                <div class=" form-group fancy-radio">
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="check1">
                                            <input name="leave_type" value="Half Day" type="radio" id="check1" checked>
                                            <span>
                                                <i></i>Half Day
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-check-inline">
                                        <div class=" form-group fancy-radio">
                                            <label class="form-check-label" for="check2">
                                                <input name="leave_type" value="Full Day" type="radio" id="check2">
                                                <span>
                                                    <i></i>Full Day
                                                </span>
                                            </label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" data-provide="datepicker"  data-date-autoclose="true" class="form-control datetime" placeholder="" name="from_date" required>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" data-provide="datepicker"  id="ddd" data-date-autoclose="true" class="form-control datetime" placeholder="" name="to_date" required>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="form-group col-sm-6">
                            ...
                            <input type="number" class="form-control" value="<?php echo $users['mobile'] ?>" name="Contact_No_during_leave">
                        </div>
...
<div class="modal animated bounceIn" id="updateDepartments" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel"><i class="icon-pencil" ></i> Update Employee</h6>
            </div>
           <form  action="update-leave-employee" method="POST" name="addemployeeform"  onsubmit="return addempvalidationn()">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-4">
                            <div class="form-group option-width">
                                <label>Department</label>
                                <br />
                                <input type="text" class="form-control"  value="<?php echo $users['user_type']?>" readonly />
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class=" form-group fancy-radio">
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="check1">
                                            <input name="upleave_type" value="Half Day" type="radio" id="check3">
                                            <span>
                                                <i></i>Half Day
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-check-inline">
                                        <div class=" form-group fancy-radio">
                                            <label class="form-check-label" for="check2">
                                                <input name="upleave_type" value="Full Day" type="radio" id="check4">
                                                <span>
                                                    <i></i>Full Day
                                                </span>
                                            </label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" data-provide="datepicker" id="update_leavefrom"  data-date-autoclose="true"
                                     class="form-control datetime" placeholder="" name="update_leavefrom">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" data-provide="datepicker"  id="update_leaveto" data-date-autoclose="true" 
                                    class="form-control datetime" placeholder="" name="update_leaveto">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 form-group">
                            <label>Leave Purpose</label>
                            <textarea class="form-control" id="update_leave_purpose" rows="3" cols="20" required 
                            name="update_leave_purpose"></textarea>
                        </div>

                        <div class="form-group col-sm-6 ">
                            <label>Address During Leave</label>
                            <textarea class="form-control" id="update_addressduring_leave" rows="3" cols="20" required 
                            name="update_addressduring_leave"></textarea>
                        </div>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <form  action="delete-employee-leave" method="POST" >
                <div class="modal-content">
...
<script type="text/javascript">
    ...
    function update_employee(id,leave_form,leave_to,leave_reason,leave_type,contact_number,leave_purpose,addressduring_leave){
        $('#update_id').val(id);
