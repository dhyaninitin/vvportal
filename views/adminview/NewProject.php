            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" onclick="window.history.go(-1); return false;" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Project</h2>
                        <ul class="breadcrumb">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-provide="datepicker" id="startprojectdate" name="startdate" data-date-autoclose="true" class="form-control"
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="endprojectdate" autocomplete="off" name="end_date" data-provide="datepicker" data-date-autoclose="true" 
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" id="dollerprice" name="dollerprice" value="73.32" class="form-control" placeholder="Doller Price  *">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" id="projectprice" name="projectprice" class="form-control" placeholder="Enter Project Price  *">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group">                                        
                                                <select name="employeteam[]" id="Brand_namee" class="form-control Brand_namee" multiple="multiple" onchange="getemployeevalue(this.value)">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" name="proejct_desc" rows="7" cols="6" placeholder="Write project description"></textarea>
                                        </div>                               
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mt-4" style="float: right;">
                                                <button type="submit" class="btn btn-primary"><i class="icon-plus icon-style" ></i> Add New Project</button>
        ...
        const monthNames = ["January", "February", "March", "April", "May", "June","July", "August", "September", "October", "November", "December"];
            ...
            $(".date").html(d.getDate());
                ...
                $("#endprojectdate").change(function(){
                    ...
                    var enddddd = monthNames[endprodate.getMonth()] + ' ' + endprodate.getDate() + ' ' +  endprodate.getFullYear() +' ' + '[' + weekday[endprodate.getDay()] + ']'  ;
