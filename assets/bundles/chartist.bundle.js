    ...
    return function a(b, c, d) {
        ...
        6: [function(b, c, d) {
            ! function(b, e) {
                ...
                function r(b) {
                    q(this, b), this._d = new Date(null != b._d ? b._d.getTime() : NaN), !1 === qd && (qd = !0, a.updateOffset(this), qd = !1)
                }
                ...
                function x(b, c) {
                    var d = !0;
                    return j(function() {
                        return null != a.deprecationHandler && a.deprecationHandler(null, b), d && (w(b + "\nArguments: " + Array.prototype.slice.call(arguments).join(", ") + "\n" + (new Error).stack), d = !1), c.apply(this, arguments)
                    }, c)
                }
                ...
                function K(a) {
                    return "string" == typeof a ? yd[a] || yd[a.toLowerCase()] : void 0
                }

                function L(a) {
                    var b, c, d = {};
                    for (c in a) i(a, c) && (b = K(c)) && (d[b] = a[c]);
                    return d
                }
                ...
                function W(a) {
                    ...
                    for (b = 0, c = d.length; b < c; b++) Dd[d[b]] ? d[b] = Dd[d[b]] : d[b] = V(d[b]);
                    return function(b) {
                        var e, f = "";
                ...
                function X(a, b) {
                    return a.isValid() ? (b = Y(b, a.localeData()), Cd[b] = Cd[b] || W(b), Cd[b](a)) : a.localeData().invalidDate()
                }
                ...
                function Y(a, b) {
                    ...
                    var d = 5;
                    for (Bd.lastIndex = 0; d >= 0 && Bd.test(a);) a = a.replace(Bd, c), Bd.lastIndex = 0, d -= 1;
                    return a
                }
                ...
                function $(a, b) {
                    return i(Vd, a) ? Vd[a](b._strict, b._locale) : new RegExp(_(a))
                }
                ...
                function fa(a, b) {
                    return d(this._months) ? this._months[a.month()] : this._months[(this._months.isFormat || ee).test(b) ? "format" : "standalone"][a.month()]
                }

                function ga(a, b) {
                    return d(this._monthsShort) ? this._monthsShort[a.month()] : this._monthsShort[ee.test(b) ? "format" : "standalone"][a.month()]
                }
                ...
                function ha(a, b, c) {
                    ...
                    return c ? "MMM" === b ? (e = td.call(this._shortMonthsParse, g), -1 !== e ? e : null) : (e = td.call(this._longMonthsParse, g), -1 !== e ? e : null) : "MMM" === b ? -1 !== (e = td.call(this._shortMonthsParse, g)) ? e : (e = td.call(this._longMonthsParse, g), -1 !== e ? e : null) : -1 !== (e = td.call(this._longMonthsParse, g)) ? e : (e = td.call(this._shortMonthsParse, g), -1 !== e ? e : null)
                }
                ...
                function ma(a) {
                    return this._monthsParseExact ? (i(this, "_monthsRegex") || oa.call(this), a ? this._monthsShortStrictRegex : this._monthsShortRegex) : (i(this, "_monthsShortRegex") || (this._monthsShortRegex = he), this._monthsShortStrictRegex && a ? this._monthsShortStrictRegex : this._monthsShortRegex)
                }

                function na(a) {
                    return this._monthsParseExact ? (i(this, "_monthsRegex") || oa.call(this), a ? this._monthsStrictRegex : this._monthsRegex) : (i(this, "_monthsRegex") || (this._monthsRegex = ie), this._monthsStrictRegex && a ? this._monthsStrictRegex : this._monthsRegex)
                }
                ...
                function Ia(a, b, c) {
                    ...
                    return c ? "dddd" === b ? (e = td.call(this._weekdaysParse, g), -1 !== e ? e : null) : "ddd" === b ? (e = td.call(this._shortWeekdaysParse, g), -1 !== e ? e : null) : (e = td.call(this._minWeekdaysParse, g), -1 !== e ? e : null) : "dddd" === b ? -1 !== (e = td.call(this._weekdaysParse, g)) ? e : -1 !== (e = td.call(this._shortWeekdaysParse, g)) ? e : (e = td.call(this._minWeekdaysParse, g), -1 !== e ? e : null) : "ddd" === b ? -1 !== (e = td.call(this._shortWeekdaysParse, g)) ? e : -1 !== (e = td.call(this._weekdaysParse, g)) ? e : (e = td.call(this._minWeekdaysParse, g), -1 !== e ? e : null) : -1 !== (e = td.call(this._minWeekdaysParse, g)) ? e : -1 !== (e = td.call(this._weekdaysParse, g)) ? e : (e = td.call(this._shortWeekdaysParse, g), -1 !== e ? e : null)
                }
                ...
                function Na(a) {
                    return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Qa.call(this), a ? this._weekdaysStrictRegex : this._weekdaysRegex) : (i(this, "_weekdaysRegex") || (this._weekdaysRegex = oe), this._weekdaysStrictRegex && a ? this._weekdaysStrictRegex : this._weekdaysRegex)
                }

                function Oa(a) {
                    return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Qa.call(this), a ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (i(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = pe), this._weekdaysShortStrictRegex && a ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
                }

                function Pa(a) {
                    return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Qa.call(this), a ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (i(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = qe), this._weekdaysMinStrictRegex && a ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
                }
                ...
                function Za(a) {
                    var d = null;
                    if (!ve[a] && void 0 !== c && c && c.exports) try {
                        d = re._abbr, b("./locale/" + a), $a(d)
                    } catch (a) {}
                    return ve[a]
                }
                ...
                function $a(a, b) {
                    var c;
                    return a && (c = p(b) ? bb(a) : _a(a, b)) && (re = c), re._abbr
                }

                function _a(a, b) {
                    if (null !== b) {
                        var c = ue;
                        return b.abbr = a, null != ve[a] ? (y("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), c = ve[a]._config) : null != b.parentLocale && (null != ve[b.parentLocale] ? c = ve[b.parentLocale]._config : y("parentLocaleUndefined", "specified parentLocale is not defined yet. See http://momentjs.com/guides/#/warnings/parent-locale/")), ve[a] = new C(B(c, b)), $a(a), ve[a]
                    }
                ...
                function ab(a, b) {
                    if (null != b) {
                        var c, d = ue;
                        null != ve[a] && (d = ve[a]._config), b = B(d, b), c = new C(b), c.parentLocale = ve[a], ve[a] = c, $a(a)
                    } else null != ve[a] && (null != ve[a].parentLocale ? ve[a] = ve[a].parentLocale : null != ve[a] && delete ve[a]);
                    return ve[a]
                }

                function bb(a) {
                    var b;
                    if (a && a._locale && a._locale._abbr && (a = a._locale._abbr), !a) return re;
                    if (!d(a)) {
                        if (b = Za(a)) return b;
                        a = [a]
                    }
                ...
                function db(a) {
                    var b, c = a._a;
                    return c && -2 === m(a).overflow && (b = c[Yd] < 0 || c[Yd] > 11 ? Yd : c[Zd] < 1 || c[Zd] > ea(c[Xd], c[Yd]) ? Zd : c[$d] < 0 || c[$d] > 24 || 24 === c[$d] && (0 !== c[_d] || 0 !== c[ae] || 0 !== c[be]) ? $d : c[_d] < 0 || c[_d] > 59 ? _d : c[ae] < 0 || c[ae] > 59 ? ae : c[be] < 0 || c[be] > 999 ? be : -1, m(a)._overflowDayOfYear && (b < Xd || b > Zd) && (b = Zd), m(a)._overflowWeeks && -1 === b && (b = ce), m(a)._overflowWeekday && -1 === b && (b = de), m(a).overflow = b), a
                }
                ...
                function eb(a) {
                    ...
                    if (i) {
                        for (m(a).iso = !0, b = 0, c = ze.length; b < c; b++)
                            if (ze[b][1].exec(i[1])) {
                                e = ze[b][0], d = !1 !== ze[b][2];
                                break
                            } if (null == e) return void(a._isValid = !1);
                        if (i[3]) {
                            for (b = 0, c = Ae.length; b < c; b++)
                                if (Ae[b][1].exec(i[3])) {
                                    f = (i[2] || " ") + Ae[b][0];
                                    break
                        ...
                        if (i[4]) {
                            if (!ye.exec(i[4])) return void(a._isValid = !1);
                            g = "Z"
                        }
                        a._f = e + (f || "") + (g || ""), kb(a)
                    } else a._isValid = !1
                ...
                function ib(a) {
                    var b, c, d, e, f = [];
                    if (!a._d) {
                        for (d = hb(a), a._w && null == a._a[Zd] && null == a._a[Yd] && jb(a), a._dayOfYear && (e = gb(a._a[Xd], d[Xd]), a._dayOfYear > pa(e) && (m(a)._overflowDayOfYear = !0), c = ta(e, 0, a._dayOfYear), a._a[Yd] = c.getUTCMonth(), a._a[Zd] = c.getUTCDate()), b = 0; b < 3 && null == a._a[b]; ++b) a._a[b] = f[b] = d[b];
                        for (; b < 7; b++) a._a[b] = f[b] = null == a._a[b] ? 2 === b ? 1 : 0 : a._a[b];
                        24 === a._a[$d] && 0 === a._a[_d] && 0 === a._a[ae] && 0 === a._a[be] && (a._nextDay = !0, a._a[$d] = 0), a._d = (a._useUTC ? ta : sa).apply(null, f), null != a._tzm && a._d.setUTCMinutes(a._d.getUTCMinutes() - a._tzm), a._nextDay && (a._a[$d] = 24)
                    }
                }

                function jb(a) {
                    var b, c, d, e, f, g, h, i;
                    b = a._w, null != b.GG || null != b.W || null != b.E ? (f = 1, g = 4, c = gb(b.GG, a._a[Xd], wa(sb(), 1, 4).year), d = gb(b.W, 1), ((e = gb(b.E, 1)) < 1 || e > 7) && (i = !0)) : (f = a._locale._week.dow, g = a._locale._week.doy, c = gb(b.gg, a._a[Xd], wa(sb(), f, g).year), d = gb(b.w, 1), null != b.d ? ((e = b.d) < 0 || e > 6) && (i = !0) : null != b.e ? (e = b.e + f, (b.e < 0 || b.e > 6) && (i = !0)) : e = f), d < 1 || d > xa(c, f, g) ? m(a)._overflowWeeks = !0 : null != i ? m(a)._overflowWeekday = !0 : (h = va(c, d, e, f, g), a._a[Xd] = h.year, a._dayOfYear = h.dayOfYear)
                }
                ...
                function kb(b) {
                    ...
                    var c, d, e, f, g, h = "" + b._i,
                        i = h.length,
                        j = 0;
                    for (e = Y(b._f, b._locale).match(Ad) || [], c = 0; c < e.length; c++) f = e[c], d = (h.match($(f, b)) || [])[0], d && (g = h.substr(0, h.indexOf(d)), g.length > 0 && m(b).unusedInput.push(g), h = h.slice(h.indexOf(d) + d.length), j += d.length), Dd[f] ? (d ? m(b).empty = !1 : m(b).unusedTokens.push(f), da(f, d, b)) : b._strict && !d && m(b).unusedTokens.push(f);
                    m(b).charsLeftOver = i - j, h.length > 0 && m(b).unusedInput.push(h), b._a[$d] <= 12 && !0 === m(b).bigHour && b._a[$d] > 0 && (m(b).bigHour = void 0), m(b).parsedDateParts = b._a.slice(0), m(b).meridiem = b._meridiem, b._a[$d] = lb(b._locale, b._a[$d], b._meridiem), ib(b), db(b)
                }
                ...
                function Cb(b, c) {
                    ...
                    return this.isValid() ? null != b ? ("string" == typeof b ? b = zb(Sd, b) : Math.abs(b) < 16 && (b *= 60), !this._isUTC && c && (d = Bb(this)), this._offset = b, this._isUTC = !0, null != d && this.add(d, "m"), e !== b && (!c || this._changeInProgress ? Tb(this, Nb(b - e, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, a.updateOffset(this, !0), this._changeInProgress = null)), this) : this._isUTC ? e : Bb(this) : null != b ? this : NaN
                }
                ...
                function Gb() {
                    return this._tzm ? this.utcOffset(this._tzm) : "string" == typeof this._i && this.utcOffset(zb(Rd, this._i)), this
                }
                ...
                function Nb(a, b) {
                    ...
                    return xb(a) ? f = {
                        ...
                        d: a._days,
                        M: a._months
                    } : "number" == typeof a ? (f = {}, b ? f[b] = a : f.milliseconds = a) : (g = Ge.exec(a)) ? (c = "-" === g[1] ? -1 : 1, f = {
                        y: 0,
                        d: u(g[Zd]) * c,
                        h: u(g[$d]) * c,
                        m: u(g[_d]) * c,
                ...
                function Sb(a, b) {
                    return function(c, d) {
                        var e, f;
                        return null === d || isNaN(+d) || (y(b, "moment()." + b + "(period, number) is deprecated. Please use moment()." + b + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), f = c, c = d, d = f), c = "string" == typeof c ? +c : c, e = Nb(c, d), Tb(this, e, a), this
                    }
                }
                ...
                function Vc() {
                    var a = this._data;
                    return this._milliseconds = Te(this._milliseconds), this._days = Te(this._days), this._months = Te(this._months), a.milliseconds = Te(a.milliseconds), a.seconds = Te(a.seconds), a.minutes = Te(a.minutes), a.hours = Te(a.hours), a.months = Te(a.months), a.years = Te(a.years), this
                }
                ...
                function bd(a) {
                    ...
                    if ("month" === (a = K(a)) || "year" === a) return b = this._days + d / 864e5, c = this._months + _c(b), "month" === a ? c : c / 12;
                ...
                function md() {
                    var a, b, c, d = kf(this._milliseconds) / 1e3,
                        e = kf(this._days),
                        f = kf(this._months);
                ...
                var td, ud = {
                    ...
                    yd = {},
                    zd = {},
                    Ad = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
                    Bd = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,
                    Cd = {},
                    Dd = {},
                    Ed = /\d/,
                    Fd = /\d\d/,
                ...
                td = Array.prototype.indexOf ? Array.prototype.indexOf : function(a) {
                ...
                }), J("month", "M"), M("month", 8), Z("M", Jd), Z("MM", Jd, Fd), Z("MMM", function(a, b) {
                    ...
                    null != e ? b[Yd] = e : m(c).invalidMonth = a
                });
                var ee = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
                ...
                }), U(0, ["YYYY", 4], 0, "year"), U(0, ["YYYYY", 5], 0, "year"), U(0, ["YYYYYY", 6, !0], 0, "year"), J("year", "y"), M("year", 1), Z("Y", Qd), Z("YY", Jd, Fd), Z("YYYY", Nd, Hd), Z("YYYYY", Od, Id), Z("YYYYYY", Od, Id), ba(["YYYYY", "YYYYYY"], Xd), ba("YYYY", function(b, c) {
                    c[Xd] = 2 === b.length ? a.parseTwoDigitYear(b) : u(b)
                }), ba("YY", function(b, c) {
                    c[Xd] = a.parseTwoDigitYear(b)
                }), ba("Y", function(a, b) {
                    b[Xd] = parseInt(a, 10)
                ...
                var je = O("FullYear", !0);
                U("w", ["ww", 2], "wo", "week"), U("W", ["WW", 2], "Wo", "isoWeek"), J("week", "w"), J("isoWeek", "W"), M("week", 5), M("isoWeek", 5), Z("w", Jd), Z("ww", Jd, Fd), Z("W", Jd), Z("WW", Jd, Fd), ca(["w", "ww", "W", "WW"], function(a, b, c, d) {
                    b[d.substr(0, 1)] = u(a)
                });
                var ke = {
                    dow: 0,
                ...
                }), U("e", 0, 0, "weekday"), U("E", 0, 0, "isoWeekday"), J("day", "d"), J("weekday", "e"), J("isoWeekday", "E"), M("day", 11), M("weekday", 11), M("isoWeekday", 11), Z("d", Jd), Z("e", Jd), Z("E", Jd), Z("dd", function(a, b) {
                ...
                var le = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                    me = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),
                ...
                }), Ta("a", !0), Ta("A", !1), J("hour", "h"), M("hour", 13), Z("a", Ua), Z("A", Ua), Z("H", Jd), Z("h", Jd), Z("HH", Jd, Fd), Z("hh", Jd, Fd), Z("hmm", Kd), Z("hmmss", Ld), Z("Hmm", Kd), Z("Hmmss", Ld), ba(["H", "HH"], $d), ba(["a", "A"], function(a, b, c) {
                    c._isPm = c._locale.isPM(a), c._meridiem = a
                }), ba(["h", "hh"], function(a, b, c) {
                    b[$d] = u(a), m(c).bigHour = !0
                }), ba("hmm", function(a, b, c) {
                    var d = a.length - 2;
                    b[$d] = u(a.substr(0, d)), b[_d] = u(a.substr(d)), m(c).bigHour = !0
                }), ba("hmmss", function(a, b, c) {
                    var d = a.length - 4,
                        e = a.length - 2;
                    b[$d] = u(a.substr(0, d)), b[_d] = u(a.substr(d, 2)), b[ae] = u(a.substr(e)), m(c).bigHour = !0
                }), ba("Hmm", function(a, b, c) {
                    var d = a.length - 2;
                    b[$d] = u(a.substr(0, d)), b[_d] = u(a.substr(d))
                }), ba("Hmmss", function(a, b, c) {
                    var d = a.length - 4,
                        e = a.length - 2;
                    b[$d] = u(a.substr(0, d)), b[_d] = u(a.substr(d, 2)), b[ae] = u(a.substr(e))
                });
                var re, se = /[ap]\.?m?\.?/i,
                    te = O("Hours", !0),
                    ue = {
                    ...
                    Be = /^\/?Date\((\-?\d+)/i;
                a.createFromInputFallback = x("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.", function(a) {
                    a._d = new Date(a._i + (a._useUTC ? " UTC" : ""))
                }), a.ISO_8601 = function() {};
                var Ce = x("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                        var a = sb.apply(null, arguments);
                        return this.isValid() && a.isValid() ? a < this ? this : a : o()
                    }),
                    De = x("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                        var a = sb.apply(null, arguments);
                        return this.isValid() && a.isValid() ? a > this ? this : a : o()
                    }),
                    Ee = function() {
                ...
                yb("Z", ":"), yb("ZZ", ""), Z("Z", Sd), Z("ZZ", Sd), ba(["Z", "ZZ"], function(a, b, c) {
                    c._useUTC = !0, c._tzm = zb(Sd, a)
                });
                var Fe = /([\+\-]|\d\d)/gi;
                a.updateOffset = function() {};
                var Ge = /^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/,
                    He = /^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;
                Nb.fn = wb.prototype;
                var Ie = Sb(1, "add"),
                    Je = Sb(-1, "subtract");
                a.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ", a.defaultFormatUtc = "YYYY-MM-DDTHH:mm:ss[Z]";
                var Ke = x("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(a) {
                ...
                }), yc("gggg", "weekYear"), yc("ggggg", "weekYear"), yc("GGGG", "isoWeekYear"), yc("GGGGG", "isoWeekYear"), J("weekYear", "gg"), J("isoWeekYear", "GG"), M("weekYear", 1), M("isoWeekYear", 1), Z("G", Qd), Z("g", Qd), Z("GG", Jd, Fd), Z("gg", Jd, Fd), Z("GGGG", Nd, Hd), Z("gggg", Nd, Hd), Z("GGGGG", Od, Id), Z("ggggg", Od, Id), ca(["gggg", "ggggg", "GGGG", "GGGGG"], function(a, b, c, d) {
                    b[d.substr(0, 2)] = u(a)
                }), ca(["gg", "GG"], function(b, c, d, e) {
                    c[e] = a.parseTwoDigitYear(b)
                }), U("Q", 0, "Qo", "quarter"), J("quarter", "Q"), M("quarter", 7), Z("Q", Ed), ba("Q", function(a, b) {
                    b[Yd] = 3 * (u(a) - 1)
                }), U("D", ["DD", 2], "Do", "date"), J("date", "D"), M("date", 9), Z("D", Jd), Z("DD", Jd, Fd), Z("Do", function(a, b) {
                    return a ? b._ordinalParse : b._ordinalParseLenient
                }), ba(["D", "DD"], Zd), ba("Do", function(a, b) {
                    b[Zd] = u(a.match(Jd)[0], 10)
                });
                var Le = O("Date", !0);
                U("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), J("dayOfYear", "DDD"), M("dayOfYear", 4), Z("DDD", Md), Z("DDDD", Gd), ba(["DDD", "DDDD"], function(a, b, c) {
                    c._dayOfYear = u(a)
                }), U("m", ["mm", 2], 0, "minute"), J("minute", "m"), M("minute", 14), Z("m", Jd), Z("mm", Jd, Fd), ba(["m", "mm"], _d);
                var Me = O("Minutes", !1);
                U("s", ["ss", 2], 0, "second"), J("second", "s"), M("second", 15), Z("s", Jd), Z("ss", Jd, Fd), ba(["s", "ss"], ae);
                var Ne = O("Seconds", !1);
                U("S", 0, 0, function() {
                ...
                }), J("millisecond", "ms"), M("millisecond", 16), Z("S", Md, Ed), Z("SS", Md, Fd), Z("SSS", Md, Gd);
                var Oe;
                for (Oe = "SSSS"; Oe.length <= 9; Oe += "S") Z(Oe, Pd);
                for (Oe = "S"; Oe.length <= 9; Oe += "S") ba(Oe, Hc);
                var Pe = O("Milliseconds", !1);
                U("z", 0, 0, "zoneAbbr"), U("zz", 0, 0, "zoneName");
                var Qe = r.prototype;
                Qe.add = Ie, Qe.calendar = Vb, Qe.clone = Wb, Qe.diff = bc, Qe.endOf = nc, Qe.format = fc, Qe.from = gc, Qe.fromNow = hc, Qe.to = ic, Qe.toNow = jc, Qe.get = R, Qe.invalidAt = wc, Qe.isAfter = Xb, Qe.isBefore = Yb, Qe.isBetween = Zb, Qe.isSame = $b, Qe.isSameOrAfter = _b, Qe.isSameOrBefore = ac, Qe.isValid = uc, Qe.lang = Ke, Qe.locale = kc, Qe.localeData = lc, Qe.max = De, Qe.min = Ce, Qe.parsingFlags = vc, Qe.set = S, Qe.startOf = mc, Qe.subtract = Je, Qe.toArray = rc, Qe.toObject = sc, Qe.toDate = qc, Qe.toISOString = ec, Qe.toJSON = tc, Qe.toString = dc, Qe.unix = pc, Qe.valueOf = oc, Qe.creationData = xc, Qe.year = je, Qe.isLeapYear = ra, Qe.weekYear = zc, Qe.isoWeekYear = Ac, Qe.quarter = Qe.quarters = Fc, Qe.month = ka, Qe.daysInMonth = la, Qe.week = Qe.weeks = Ba, Qe.isoWeek = Qe.isoWeeks = Ca, Qe.weeksInYear = Cc, Qe.isoWeeksInYear = Bc, Qe.date = Le, Qe.day = Qe.days = Ka, Qe.weekday = La, Qe.isoWeekday = Ma, Qe.dayOfYear = Gc, Qe.hour = Qe.hours = te, Qe.minute = Qe.minutes = Me, Qe.second = Qe.seconds = Ne, Qe.millisecond = Qe.milliseconds = Pe, Qe.utcOffset = Cb, Qe.utc = Eb, Qe.local = Fb, Qe.parseZone = Gb, Qe.hasAlignedHourOffset = Hb, Qe.isDST = Ib, Qe.isLocal = Kb, Qe.isUtcOffset = Lb, Qe.isUtc = Mb, Qe.isUTC = Mb, Qe.zoneAbbr = Ic, Qe.zoneName = Jc, Qe.dates = x("dates accessor is deprecated. Use date instead.", Le), Qe.months = x("months accessor is deprecated. Use month instead", ka), Qe.years = x("years accessor is deprecated. Use year instead", je), Qe.zone = x("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Db), Qe.isDSTShifted = x("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Jb);
                var Re = Qe,
                    Se = C.prototype;
                Se.calendar = D, Se.longDateFormat = E, Se.invalidDate = F, Se.ordinal = G, Se.preparse = Mc, Se.postformat = Mc, Se.relativeTime = H, Se.pastFuture = I, Se.set = A, Se.months = fa, Se.monthsShort = ga, Se.monthsParse = ia, Se.monthsRegex = na, Se.monthsShortRegex = ma, Se.week = ya, Se.firstDayOfYear = Aa, Se.firstDayOfWeek = za, Se.weekdays = Fa, Se.weekdaysMin = Ha, Se.weekdaysShort = Ga, Se.weekdaysParse = Ja, Se.weekdaysRegex = Na, Se.weekdaysShortRegex = Oa, Se.weekdaysMinRegex = Pa, Se.isPM = Va, Se.meridiem = Wa, $a("en", {
                ...
                var Te = Math.abs,
                    ...
                    kf = Math.abs,
                    lf = wb.prototype;
                return lf.abs = Vc, lf.add = Xc, lf.subtract = Yc, lf.as = bd, lf.asMilliseconds = Ue, lf.asSeconds = Ve, lf.asMinutes = We, lf.asHours = Xe, lf.asDays = Ye, lf.asWeeks = Ze, lf.asMonths = $e, lf.asYears = _e, lf.valueOf = cd, lf._bubble = $c, lf.get = ed, lf.milliseconds = af, lf.seconds = bf, lf.minutes = cf, lf.hours = df, lf.days = ef, lf.weeks = gd, lf.months = ff, lf.years = gf, lf.humanize = ld, lf.toISOString = md, lf.toString = md, lf.toJSON = md, lf.locale = kc, lf.localeData = lc, lf.toIsoString = x("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", md), lf.lang = Ke, U("X", 0, 0, "unix"), U("x", 0, 0, "valueOf"), Z("x", Qd), Z("X", Td), ba("X", function(a, b, c) {
                    ...
                    function(a) {
                        nd = a
                    }(sb), a.fn = Re, a.min = ub, a.max = vb, a.now = Ee, a.utc = k, a.unix = Kc, a.months = Qc, a.isDate = g, a.locale = $a, a.invalid = o, a.duration = Nb, a.isMoment = s, a.weekdays = Sc, a.parseZone = Lc, a.localeData = bb, a.isDuration = xb, a.monthsShort = Rc, a.weekdaysMin = Uc, a.defineLocale = _a, a.updateLocale = ab, a.locales = cb, a.weekdaysShort = Tc, a.normalizeUnits = K, a.relativeTimeRounding = jd, a.relativeTimeThreshold = kd, a.calendarFormat = Ub, a.prototype = Re, a
            })
        }, {}],
        7: [function(a, b, c) {
            var d = a(27)();
            a(26)(d), a(22)(d), a(25)(d), a(21)(d), a(23)(d), a(24)(d), a(28)(d), a(32)(d), a(30)(d), a(31)(d), a(33)(d), a(29)(d), a(34)(d), a(35)(d), a(36)(d), a(37)(d), a(38)(d), a(41)(d), a(39)(d), a(40)(d), a(42)(d), a(43)(d), a(44)(d), a(15)(d), a(16)(d), a(17)(d), a(18)(d), a(19)(d), a(20)(d), a(8)(d), a(9)(d), a(10)(d), a(11)(d), a(12)(d), a(13)(d), a(14)(d), window.Chart = b.exports = d
        }, {
            10: 10,
            11: 11,
            12: 12,
                ...
                a.defaults.bar = {
                    ...
                    getBarCount: function() {
                        ...
                        return b.each(a.chart.data.datasets, function(b, d) {
                            a.chart.getDatasetMeta(d).bar && a.chart.isDatasetVisible(d) && ++c
                        }, a), c
                    },
                    update: function(a) {
                        var c = this;
                    ...
                    calculateBarBase: function(a, b) {
                        ...
                        if (e.options.stacked) {
                            for (var g = c.chart, h = g.data.datasets, i = Number(h[a].data[b]), j = 0; j < a; j++) {
                                var k = h[j],
                                    l = g.getDatasetMeta(j);
                                if (l.bar && l.yAxisID === e.id && g.isDatasetVisible(j)) {
                                    var m = Number(k.data[b]);
                                    f += i < 0 ? Math.min(m, 0) : Math.max(m, 0)
                                }
                            }
                    ...
                    getRuler: function(a) {
                        ...
                        if (e.ticks.length !== c.chart.data.labels.length) {
                            i *= e.ticks.length / c.chart.data.labels.length
                        }
                        return {
                            datasetCount: f,
                            tickWidth: b,
                            ...
                            categorySpacing: h,
                            fullBarWidth: i,
                            barWidth: i * e.options.barPercentage,
                            barSpacing: i - i * e.options.barPercentage
                        }
                    },
                    calculateBarWidth: function(a) {
                        var b = this.getScaleForId(this.getMeta().xAxisID);
                        if (b.options.barThickness) return b.options.barThickness;
                        var c = this.getRuler(a);
                    ...
                    calculateBarY: function(a, b) {
                        var c = this,
                            d = c.getMeta(),
                            e = c.getScaleForId(d.yAxisID),
                            f = Number(c.getDataset().data[a]);
                        if (e.options.stacked) {
                            for (var g = 0, h = 0, i = 0; i < b; i++) {
                                var j = c.chart.data.datasets[i],
                                    k = c.chart.getDatasetMeta(i);
                                if (k.bar && k.yAxisID === e.id && c.chart.isDatasetVisible(i)) {
                                    var l = Number(j.data[a]);
                                    l < 0 ? h += l || 0 : g += l || 0
                                }
                            }
                    ...
                    updateElement: function(a, c, d) {
                        var e = this,
                            ...
                            j = a.custom || {},
                            k = e.getDataset(),
                            l = e.chart.options.elements.rectangle;
                        b.extend(a, {
                            _xScale: g,
                            _yScale: h,
                            _datasetIndex: e.index,
                            _index: c,
                            _model: {
                                x: d ? i : e.calculateBarX(c, e.index),
                                y: e.calculateBarY(c, e.index),
                                label: e.chart.data.labels[c],
                                datasetLabel: k.label,
                                base: d ? i : e.calculateBarBase(e.index, c),
                                height: e.calculateBarHeight(c),
                                backgroundColor: j.backgroundColor ? j.backgroundColor : b.getValueAtIndexOrDefault(k.backgroundColor, c, l.backgroundColor),
                                borderSkipped: j.borderSkipped ? j.borderSkipped : l.borderSkipped,
                                borderColor: j.borderColor ? j.borderColor : b.getValueAtIndexOrDefault(k.borderColor, c, l.borderColor),
                                borderWidth: j.borderWidth ? j.borderWidth : b.getValueAtIndexOrDefault(k.borderWidth, c, l.borderWidth)
                            },
                            draw: function() {
                                function a(a) {
                                    return i[(k + a) % 4]
                                ...
                                var i = [
                                    ...
                                    k = j.indexOf(c.borderSkipped, 0); - 1 === k && (k = 0), b.moveTo.apply(b, a(0));
                    ...
                    calculateBarBase: function(a, b) {
                        ...
                        if (e.options.stacked) {
                            for (var g = c.chart, h = g.data.datasets, i = Number(h[a].data[b]), j = 0; j < a; j++) {
                                var k = h[j],
                                    l = g.getDatasetMeta(j);
                                if (l.bar && l.xAxisID === e.id && g.isDatasetVisible(j)) {
                                    var m = Number(k.data[b]);
                                    f += i < 0 ? Math.min(m, 0) : Math.max(m, 0)
                                }
                            }
                    ...
                    getRuler: function(a) {
                        ...
                        return {
                            ...
                            categorySpacing: h,
                            fullBarHeight: i,
                            barHeight: i * e.options.barPercentage,
                            barSpacing: i - i * e.options.barPercentage
                        }
                    },
                    calculateBarHeight: function(a) {
                        ...
                        if (c.options.barThickness) return c.options.barThickness;
                        var d = b.getRuler(a);
                    ...
                    calculateBarX: function(a, b) {
                        ...
                        if (e.options.stacked) {
                            for (var g = 0, h = 0, i = 0; i < b; i++) {
                                var j = c.chart.data.datasets[i],
                                    k = c.chart.getDatasetMeta(i);
                                if (k.bar && k.xAxisID === e.id && c.chart.isDatasetVisible(i)) {
                                    var l = Number(j.data[a]);
                                    l < 0 ? h += l || 0 : g += l || 0
                                }
                            }
                ...
                a.defaults.bubble = {
                    ...
                    updateElement: function(c, d, e) {
                        ...
                        b.extend(c, {
                            ...
                            _index: d,
                            _model: {
                                x: e ? h.getPixelForDecimal(.5) : h.getPixelForValue("object" == typeof l ? l : NaN, d, n, f.chart.isCombo),
                    ...
                    setHoverStyle: function(c) {
                        ...
                        var e = d.chart.data.datasets[c._datasetIndex],
                            f = c._index,
                            g = c.custom || {};
                        c._model.radius = g.hoverRadius ? g.hoverRadius : b.getValueAtIndexOrDefault(e.hoverRadius, f, d.chart.options.elements.point.hoverRadius) + d.getRadius(e.data[f])
                    },
                    removeHoverStyle: function(b) {
                        ...
                        var d = c.chart.data.datasets[b._datasetIndex].data[b._index],
                            e = b.custom || {};
                        b._model.radius = e.radius ? e.radius : c.getRadius(d)
                    }
                })
            }
        }, {}],
            ...
            b.exports = function(a) {
                ...
                c.doughnut = {
                        ...
                        labels: {
                            generateLabels: function(a) {
                                ...
                                return c.labels.length && c.datasets.length ? c.labels.map(function(d, e) {
                                    ...
                                    return {
                                        text: d,
                                        fillStyle: i.backgroundColor ? i.backgroundColor : j(g.backgroundColor, e, k.backgroundColor),
                                        strokeStyle: i.borderColor ? i.borderColor : j(g.borderColor, e, k.borderColor),
                                        lineWidth: i.borderWidth ? i.borderWidth : j(g.borderWidth, e, k.borderWidth),
                    ...
                    update: function(a) {
                        ...
                        d.borderWidth = c.getMaxBorderWidth(l.data), d.outerRadius = Math.max((j - d.borderWidth) / 2, 0), d.innerRadius = Math.max(m ? d.outerRadius / 100 * m : 1, 0), d.radiusLength = (d.outerRadius - d.innerRadius) / d.getVisibleDatasetCount(), d.offsetX = k.x * d.outerRadius, d.offsetY = k.y * d.outerRadius, l.total = c.calculateTotal(), c.outerRadius = d.outerRadius - d.radiusLength * c.getRingIndex(c.index), c.innerRadius = c.outerRadius - d.radiusLength, b.each(l.data, function(b, d) {
                            c.updateElement(b, d, a)
                        })
                    },
                    updateElement: function(a, c, d) {
                        ...
                        var s = a._model;
                        this.removeHoverStyle(a), d && i.animateRotate || (s.startAngle = 0 === c ? h.rotation : e.getMeta().data[c - 1]._model.endAngle, s.endAngle = s.startAngle + s.circumference), a.pivot()
                    },
                    removeHoverStyle: function(b) {
                ...
                a.defaults.line = {
                    ...
                    update: function(a) {
                        ...
                        for (o && (f = i.custom || {}, void 0 !== n.tension && void 0 === n.lineTension && (n.lineTension = n.tension), i._scale = m, i._datasetIndex = g.index, i._children = j, i._model = {
                                ...
                                steppedLine: f.steppedLine ? f.steppedLine : c.getValueOrDefault(n.steppedLine, l.stepped),
                                scaleTop: m.top,
                    ...
                    updateElement: function(a, b, d) {
                        ...
                        void 0 !== j.radius && void 0 === j.pointRadius && (j.pointRadius = j.radius), void 0 !== j.hitRadius && void 0 === j.pointHitRadius && (j.pointHitRadius = j.hitRadius), e = n.getPixelForValue("object" == typeof l ? l : NaN, b, k, g.chart.isCombo), f = d ? m.getBasePixel() : g.calculatePointY(l, b, k), a._xScale = n, a._yScale = m, a._datasetIndex = k, a._index = b, a._model = {
                            x: e,
                            y: f,
                    ...
                    updateBezierControlPoints: function() {
                        function a(a, b, c) {
                            return l ? Math.max(Math.min(a, c), b) : a
                        }
                        var b, d, e, f, g, h = this,
                            i = h.getMeta(),
                            j = h.chart.chartArea,
                            k = (i.data || []).filter(function(a) {
                                return !a._model.skip
                            }),
                            l = h.chart.options.elements.line.capBezierPoints;
                        for (b = 0, d = k.length; b < d; ++b) e = k[b], f = e._model, g = c.splineCurve(c.previousItem(k, b)._model, f, c.nextItem(k, b)._model, i.dataset._model.tension), f.controlPointPreviousX = a(g.previous.x, j.left, j.right), f.controlPointPreviousY = a(g.previous.y, j.top, j.bottom), f.controlPointNextX = a(g.next.x, j.left, j.right), f.controlPointNextY = a(g.next.y, j.top, j.bottom)
                    },
                    draw: function(a) {
                        var c, d, e = this,
                            f = e.getMeta(),
        ...
        19: [function(a, b, c) {
            ...
            b.exports = function(a) {
                ...
                a.defaults.polarArea = {
                    ...
                    updateElement: function(a, c, d) {
                        for (var e = this, f = e.chart, g = e.getDataset(), h = f.options, i = h.animation, j = f.scale, k = b.getValueAtIndexOrDefault, l = f.data.labels, m = e.calculateCircumference(g.data[c]), n = j.xCenter, o = j.yCenter, p = 0, q = e.getMeta(), r = 0; r < c; ++r) isNaN(g.data[r]) || q.data[r].hidden || ++p;
                        var s = h.startAngle,
                            t = a.hidden ? 0 : j.getDistanceFromCenterForValue(g.data[c]),
                            u = s + m * p,
                            v = u + (a.hidden ? 0 : m),
                            w = i.animateScale ? 0 : j.getDistanceFromCenterForValue(g.data[c]);
                        b.extend(a, {
                            _datasetIndex: e.index,
                            _index: c,
                            _scale: j,
                            _model: {
                                ...
                                innerRadius: 0,
                                outerRadius: d ? w : t,
                                startAngle: d && i.animateRotate ? s : u,
                                endAngle: d && i.animateRotate ? s : v,
                                label: k(l, c, l[c])
                            }
            ...
            b.exports = function(a) {
                ...
                a.defaults.global.animation = {
                    ...
                    cancelAnimation: function(a) {
                        ...
                        }); - 1 !== c && (this.animations.splice(c, 1), a.animating = !1)
                    },
        ...
        22: [function(a, b, c) {
            "use strict";
            b.exports = function(a) {
                (a.canvasHelpers = {}).drawPoint = function(a, b, c, d, e) {
                    var f, g, h, i, j, k;
                    if ("object" == typeof b && ("[object HTMLImageElement]" === (f = b.toString()) || "[object HTMLCanvasElement]" === f)) return void a.drawImage(b, d - b.width / 2, e - b.height / 2);
                    if (!(isNaN(c) || c <= 0)) {
                        switch (b) {
                            default:
                ...
                a.types = {}, a.instances = {}, a.controllers = {}, a.Controller = function(c) {
                    ...
                    resize: function(c) {
                        var d = this,
                            ...
                            h = e.aspectRatio,
                            i = d.options.maintainAspectRatio && !1 === isNaN(h) && isFinite(h) && 0 !== h ? g / h : b.getMaximumHeight(f);
                        if (e.width === g && e.height === i) return d;
                        f.width = e.width = g, f.height = e.height = i, b.retinaScale(e);
                        var j = {
                            width: g,
                            height: i
                        };
                        return a.plugins.notify("resize", [d, j]), d.options.onResize && d.options.onResize(d, j), c || (d.stop(), d.update(d.options.responsiveAnimationDuration)), d
                    },
                    ...
                    buildScales: function() {
                        ...
                        d.scales && (f = f.concat((d.scales.xAxes || []).map(function(a) {
                            ...
                            var f = d.options,
                                g = b.getValueOrDefault(f.type, d.dtype),
                                h = a.scaleService.getScaleConstructor(g);
                            if (h) {
                                var i = new h({
                                    id: f.id,
                                    options: f,
                                ...
                                e[i.id] = i, d.isDefault && (c.scale = i)
                            }
                    ...
                    render: function(c, d) {
                        ...
                        if (f && (void 0 !== c && 0 !== c || void 0 === c && 0 !== f.duration)) {
                            ...
                            f = function() {
                                if (c.data.datasets)
                                    for (var a = 0; a < c.data.datasets.length; a++) {
                                        ...
                                        if (c.isDatasetVisible(a))
                                            for (var e = 0; e < b.data.length; e++)
                                                if (b.data[e].inLabelRange(d.x, d.y)) return b.data[e]
                                    }
                            }.call(c);
                        return f ? (b.each(c.data.datasets, function(a, d) {
                            if (c.isDatasetVisible(d)) {
                                var g = c.getDatasetMeta(d),
                                    h = b.findIndex(g.data, function(a) {
                                        return f._model.x === a._model.x
                                    }); - 1 === h || g.data[h]._view.skip || e.push(g.data[h])
                            }
                        }, c), e) : e
                    },
                    ...
                    eventHandler: function(a) {
                        var c = this,
                            ...
                            f = e.hover,
                            g = e.tooltips;
                        return c.lastActive = c.lastActive || [], c.lastTooltipActive = c.lastTooltipActive || [], "mouseout" === a.type ? (c.active = [], c.tooltipActive = []) : (c.active = c.getElementsAtEventForMode(a, f.mode), c.tooltipActive = c.getElementsAtEventForMode(a, g.mode)), f.onHover && f.onHover.call(c, c.active),
                            "mouseup" !== a.type && "click" !== a.type || (e.onClick && e.onClick.call(c, a, c.active), c.legend && c.legend.handleEvent && c.legend.handleEvent(a)), c.lastActive.length && c.updateHoverStyle(c.lastActive, f.mode, !1), c.active.length && f.mode && c.updateHoverStyle(c.active, f.mode, !0), (g.enabled || g.custom) && (d.initialize(), d._active = c.tooltipActive, d.update(!0)), d.pivot(), c.animating || b.arrayEquals(c.active, c.lastActive) && b.arrayEquals(c.tooltipActive, c.lastTooltipActive) || (c.stop(), (g.enabled || g.custom) && d.update(!0), c.render(f.animationDuration, !0)), c.lastActive = c.active, c.lastTooltipActive = c.tooltipActive, c
                    }
                })
            }
        }, {}],
        24: [function(a, b, c) {
            ...
            b.exports = function(a) {
                ...
                a.DatasetController = function(a, b) {
                    ...
                    draw: function(a) {
                        var c = a || 1;
                        b.each(this.getMeta().data, function(a) {
                            a.transition(c).draw()
                        })
                    },
                        ...
                        return c._view || (c._view = b.clone(c._model)), 1 === a ? (c._view = c._model, c._start = null, c) : (c._start || c.pivot(), b.each(c._model, function(d, e) {
                            if ("_" === e[0]);
                                ...
                                if (d === c._view[e]);
                                    ...
                                    var g = void 0 !== c._start[e] && !1 === isNaN(c._start[e]) ? c._start[e] : 0;
            ...
            b.exports = function(a) {
                ...
                f.each = function(a, b, c, d) {
                    ...
                    return f.each(a, function(a, c) {
                        f.isArray(a) ? b[c] = a.slice(0) : b[c] = "object" == typeof a && null !== a ? f.clone(a) : a
                    }), b
                }, f.extend = function(a) {
                ...
                var g = f.easingEffects = {
                    ...
                    easeInOutElastic: function(a) {
                        var b = 1.70158,
                            c = 0,
                            d = 1;
                        return 0 === a ? 0 : 2 == (a /= .5) ? 1 : (c || (c = .3 * 1.5 * 1), d < Math.abs(1) ? (d = 1, b = c / 4) : b = c / (2 * Math.PI) * Math.asin(1 / d), a < 1 ? d * Math.pow(2, 10 * (a -= 1)) * Math.sin((1 * a - b) * (2 * Math.PI) / c) * -.5 : d * Math.pow(2, -10 * (a -= 1)) * Math.sin((1 * a - b) * (2 * Math.PI) / c) * .5 + 1)
                    },
                    ...
                    easeOutBounce: function(a) {
                        return (a /= 1) < 1 / 2.75 ? 7.5625 * a * a * 1 : a < 2 / 2.75 ? 1 * (7.5625 * (a -= 1.5 / 2.75) * a + .75) : a < 2.5 / 2.75 ? 1 * (7.5625 * (a -= 2.25 / 2.75) * a + .9375) : 1 * (7.5625 * (a -= 2.625 / 2.75) * a + .984375)
                    },
                ...
                f.requestAnimFrame = function() {
                    ...
                    c.classlist ? c.classlist.add("chartjs-hidden-iframe") : c.setAttribute("class", "chartjs-hidden-iframe");
                    var d = c.style;
                    d.width = "100%", d.display = "block", d.border = 0, d.height = 0, d.margin = 0, d.position = "absolute", d.left = 0, d.right = 0, d.top = 0, d.bottom = 0, a.insertBefore(c, a.firstChild), (c.contentWindow || c).onresize = function() {
                        b && b()
                    }
        ...
        27: [function(a, b, c) {
            ...
            b.exports = function() {
                var a = function(b, c) {
                    ...
                    }, b.length && b[0].getContext && (b = b[0]), b.getContext && (b = b.getContext("2d")), d.ctx = b, d.canvas = b.canvas, b.canvas.style.display = b.canvas.style.display || "block", d.width = b.canvas.width || parseInt(e.getStyle(b.canvas, "width"), 10) || e.getMaximumWidth(b.canvas), d.height = b.canvas.height || parseInt(e.getStyle(b.canvas, "height"), 10) || e.getMaximumHeight(b.canvas), d.aspectRatio = d.width / d.height, (isNaN(d.aspectRatio) || !1 === isFinite(d.aspectRatio)) && (d.aspectRatio = void 0 !== c.aspectRatio ? c.aspectRatio : 2), d.originalCanvasStyleWidth = b.canvas.style.width, d.originalCanvasStyleHeight = b.canvas.style.height, e.retinaScale(d), d.controller = new a.Controller(d), e.addResizeListener(b.canvas.parentNode, function() {
                ...
                a.layoutService = {
                    ...
                    update: function(a, c, d) {
                        function e(a) {
                            ...
                            c ? (b = a.update(a.options.fullWidth ? o : u, t), v -= b.height) : (b = a.update(s, r), u -= b.width), w.push({
                                horizontal: c,
                                minSize: b,
                                box: a
                            })
                        ...
                        function f(a) {
                            var c = b.findNextWhere(w, function(b) {
                                return b.box === a
                            });
                            if (c)
                                if (a.isHorizontal()) {
                                    ...
                                    a.update(a.options.fullWidth ? o : u, p / 2, d)
                                } else a.update(c.minSize.width, v)
                        }
                        ...
                        function g(a) {
                            ...
                            c && a.update(c.minSize.width, v, d)
                        }

                        function h(a) {
                            a.isHorizontal() ? (a.left = a.options.fullWidth ? i : x, a.right = a.options.fullWidth ? c - i : x + u, a.top = E, a.bottom = E + a.height, E = a.bottom) : (a.left = D, a.right = D + a.width, a.top = z, a.bottom = z + v, D = a.right)
                        }
                        if (a) {
                            var i = 0,
                                j = b.where(a.boxes, function(a) {
                            ...
                            var o = c - 2 * i,
                                ...
                                q = o / 2,
                                r = p / 2,
                                s = (c - q) / (j.length + k.length),
                                t = (d - r) / (l.length + m.length),
                                u = o,
                                v = p,
                                w = [];
                            b.each(j.concat(k, l, m), e);
                            var x = i,
                                y = i,
                                z = 0,
                                A = 0;
                            b.each(j.concat(k), f), b.each(j, function(a) {
                                x += a.width
                            }), b.each(k, function(a) {
                                y += a.width
                            }), b.each(l.concat(m), f), b.each(l, function(a) {
                                z += a.height
                            }), b.each(m, function(a) {
                                A += a.height
                            }), b.each(j.concat(k), g), x = i, y = i, z = 0, A = 0, b.each(j, function(a) {
                                x += a.width
                            }), b.each(k, function(a) {
                                y += a.width
                            }), b.each(l, function(a) {
                            ...
                            var B = d - z - A,
                                C = c - x - y;
                            C === u && B === v || (b.each(j, function(a) {
                                a.height = B
                            }), b.each(k, function(a) {
                                a.height = B
                            }), b.each(l, function(a) {
                                a.options.fullWidth || (a.width = C)
                            }), b.each(m, function(a) {
                                a.options.fullWidth || (a.width = C)
                            }), v = B, u = C);
                            var D = i,
                                E = 0;
                            b.each(j.concat(l), h), D += u, E += v, b.each(k, h), b.each(m, h), a.chartArea = {
                                left: x,
                                top: z,
                                right: x + u,
                                bottom: z + v
                            }, b.each(n, function(b) {
                                b.left = a.chartArea.left, b.top = a.chartArea.top, b.right = a.chartArea.right, b.bottom = a.chartArea.bottom, b.update(u, v)
                            })
                        }
                    }
                }
                        ...
                        if (p ? (o.width = c.maxWidth, o.height = f ? 10 : 0) : (o.width = f ? 10 : 0, o.height = c.maxHeight), f)
                            if (g.font = m, p) {
                                ...
                                g.textAlign = "left", g.textBaseline = "top", b.each(c.legendItems, function(a, b) {
                                    var d = e.usePointStyle ? j * Math.sqrt(2) : e.boxWidth,
                                        f = d + j / 2 + g.measureText(a.text).width;
                                    q[q.length - 1] + f + e.padding >= c.width && (r += j + e.padding, q[q.length] = c.left), n[b] = {
                                        left: 0,
                                        top: 0,
                                        width: f,
                                        height: j
                                    }, q[q.length - 1] += f + e.padding
                                }), o.height += r
                            } else {
                                var s = e.padding,
                                    t = c.columnWidths = [],
                                ...
                                b.each(c.legendItems, function(a, b) {
                                    var c = e.usePointStyle ? 2 * e.boxWidth : e.boxWidth,
                                        d = c + j / 2 + g.measureText(a.text).width;
                                    w + x > o.height && (u += v + e.padding, t.push(v), v = 0, w = 0), v = Math.max(v, d), w += x, n[b] = {
                                        left: 0,
                                        top: 0,
                                        width: d,
                                        height: j
                    ...
                    draw: function() {
                        ...
                        if (d.display) {
                            ...
                            var r = e.boxWidth,
                                ...
                                t = function(b, c, e) {
                                    if (!(isNaN(r) || r <= 0)) {
                                        if (k.save(), k.fillStyle = l(e.fillStyle, f.defaultColor), k.lineCap = l(e.lineCap, g.borderCapStyle), k.lineDashOffset = l(e.lineDashOffset, g.borderDashOffset), k.lineJoin = l(e.lineJoin, g.borderJoinStyle), k.lineWidth = l(e.lineWidth, g.borderWidth), k.strokeStyle = l(e.strokeStyle, f.defaultColor), k.setLineDash && k.setLineDash(l(e.lineDash, g.borderDash)), d.labels && d.labels.usePointStyle) {
                                            var h = n * Math.SQRT2 / 2,
                                                i = h / Math.SQRT2,
                                                j = b + i,
                                                m = c + i;
                                            a.canvasHelpers.drawPoint(k, e.pointStyle, h, j, m)
                                        } else k.strokeRect(b, c, r, n), k.fillRect(b, c, r, n);
                                        k.restore()
                                    }
                                },
                                u = function(a, b, c, d) {
                            ...
                            b.each(c.legendItems, function(a, b) {
                                var d = k.measureText(a.text).width,
                                    f = e.usePointStyle ? n + n / 2 + d : r + n / 2 + d,
                                    g = j.x,
                                    l = j.y;
                                v ? g + f >= h && (l = j.y += w, j.line++, g = j.x = c.left + (h - i[j.line]) / 2) : l + w > c.bottom && (g = j.x = g + c.columnWidths[j.line] + e.padding, l = j.y = c.top, j.line++), t(g, l, a), s[b].left = g, s[b].top = l, u(g, l, a, d), v ? j.x += f + e.padding : j.y += w
                            })
                        }
                    },
                ...
                a.plugins = {
                    ...
                    notify: function(a, b) {
                        var c, d, e = this._plugins,
                            f = e.length;
                        for (c = 0; c < f; ++c)
                            if (d = e[c], "function" == typeof d[a] && !1 === d[a].apply(d, b || [])) return !1;
                        return !0
                    }
                ...
                a.defaults.scale = {
                    ...
                    fit: function() {
                        var c = this,
                            ...
                            p = e.gridLines.tickMarkLength;
                        if (d.width = j ? c.isFullWidth() ? c.maxWidth - c.margins.left - c.margins.right : c.maxWidth : i ? p : 0, d.height = j ? i ? p : 0 : c.maxHeight, h.display && i && (j ? d.height += 1.5 * o : d.width += 1.5 * o), g.display && i) {
                            c.longestTextCache || (c.longestTextCache = {});
                            var q = b.longestText(c.ctx, n, c.ticks, c.longestTextCache),
                                r = b.numberOfLabelLines(c.ticks),
                                s = .5 * k;
                            if (j) {
                                c.longestLabelWidth = q;
                                var t = Math.sin(b.toRadians(c.labelRotation)) * c.longestLabelWidth + k * r + s * r;
                                d.height = Math.min(c.maxHeight, d.height + t), c.ctx.font = n;
                                var u = c.ctx.measureText(c.ticks[0]).width,
                                    v = c.ctx.measureText(c.ticks[c.ticks.length - 1]).width,
                                    w = Math.cos(b.toRadians(c.labelRotation)),
                                    x = Math.sin(b.toRadians(c.labelRotation));
                                c.paddingLeft = 0 !== c.labelRotation ? w * u + 3 : u / 2 + 3, c.paddingRight = 0 !== c.labelRotation ? x * (k / 2) + 3 : v / 2 + 3
                            } else {
                                var y = c.maxWidth - d.width;
                                g.mirror ? q = 0 : q += c.options.ticks.padding, q < y ? d.width += q : d.width = c.maxWidth, c.paddingTop = k / 2, c.paddingBottom = k / 2
                            }
                        }
                        c.margins && (c.paddingLeft = Math.max(c.paddingLeft - c.margins.left, 0), c.paddingTop = Math.max(c.paddingTop - c.margins.top, 0), c.paddingRight = Math.max(c.paddingRight - c.margins.right, 0),
                            c.paddingBottom = Math.max(c.paddingBottom - c.margins.bottom, 0)), c.width = d.width, c.height = d.height
                    },
                    afterFit: function() {
                    ...
                    getRightValue: function(a) {
                        return null === a || void 0 === a ? NaN : "number" == typeof a && isNaN(a) ? NaN : "object" == typeof a ? a instanceof Date || a.isValid ? a : this.getRightValue(this.isHorizontal() ? a.x : a.y) : a
                    },
                        ...
                        if (e.display) {
                            ...
                            if (b.each(d.ticks, function(a, g) {
                                    if (void 0 !== a && null !== a) {
                                        ...
                                        if ((!(f > 1 && g % f > 0 || g % f == 0 && g + f >= d.ticks.length) || h) && void 0 !== a && null !== a) {
                                            var i, l;
                                            g === (void 0 !== d.zeroLineIndex ? d.zeroLineIndex : 0) ? (i = k.zeroLineWidth, l = k.zeroLineColor) : (i = b.getValueAtIndexOrDefault(k.lineWidth, g), l = b.getValueAtIndexOrDefault(k.color, g));
                                            var n, p, q, r, s, t, v, w, x, y, z, B = "middle";
                                            if (o) {
                                                m || (B = "top" === e.position ? "bottom" : "top"), z = m ? "right" : "center";
                                                var C = d.getPixelForTick(g) + b.aliasPixel(i);
                                                x = d.getPixelForTick(g, k.offsetGridLines) + j.labelOffset, y = m ? d.top + 12 : "top" === e.position ? d.bottom - u : d.top + u, n = q = s = v = C, p = G, r = H, t = c.top, w = c.bottom
                                            } else {
                                                "left" === e.position ? j.mirror ? (x = d.right + j.padding, z = "left") : (x = d.right - j.padding, z = "right") : j.mirror ? (x = d.left - j.padding, z = "right") : (x = d.left + j.padding, z = "left");
                                                var I = d.getPixelForTick(g);
                                                I += b.aliasPixel(i), y = d.getPixelForTick(g, k.offsetGridLines), n = E, q = F, s = c.left, v = c.right, p = r = t = w = I
                                            }
                                            D.push({
                                                tx1: n,
                                                ty1: p,
        ...
        34: [function(a, b, c) {
            ...
            b.exports = function(a) {
                ...
                function c(a) {
                    ...
                    var h = 0,
                        i = 0;
                    for (b = 0; b < d.length; ++b) d[b] && (h += d[b], i += e[b]);
                    return {
                ...
                a.defaults.global.tooltips = {
                    ...
                    getBackgroundPoint: function(a, b) {
                        var c = {
                            ...
                            i = d + e,
                            j = f + e;
                        return "right" === g ? c.x -= b.width : "center" === g && (c.x -= b.width / 2), "top" === h ? c.y += i : c.y -= "bottom" === h ? b.height + i : b.height / 2, "center" === h ? "left" === g ? c.x += i : "right" === g && (c.x -= i) : "left" === g ? c.x -= j : "right" === g && (c.x += j), c
                    },
                    drawCaret: function(a, b, c) {
                        var d, f, g, h, i, j, k = this._view,
                            l = this._chart.ctx,
                            m = k.caretSize,
                            n = k.cornerRadius,
                            o = k.xAlign,
                            ...
                            s = b.width,
                            t = b.height;
                        "center" === p ? ("left" === o ? (d = q, f = d - m, g = d) : (d = q + s, f = d + m, g = d), i = r + t / 2, h = i - m, j = i + m) : ("left" === o ? (d = q + n, f = d + m, g = f + m) : "right" === o ? (d = q + s - n, f = d - m, g = f - m) : (f = q + s / 2, d = f - m, g = f + m), "top" === p ? (h = r, i = h - m, j = h) : (h = r + t, i = h + m, j = h));
                        var u = e.color(k.backgroundColor);
                        l.fillStyle = u.alpha(c * u.alpha()).rgbString(), l.beginPath(), l.moveTo(d, h), l.lineTo(f, i), l.lineTo(g, j), l.closePath(), l.fill()
                    },
                    ...
                    draw: function() {
                        ...
                        if (0 !== b.opacity) {
                            ...
                            if (this._options.enabled) {
                                ...
                                a.fillStyle = g.alpha(f * g.alpha()).rgbString(), e.drawRoundedRectangle(a, d.x, d.y, c.width, c.height, b.cornerRadius), a.fill(), this.drawCaret(d, c, f), d.x += b.xPadding, d.y += b.yPadding, this.drawTitle(d, b, a, f), this.drawBody(d, b, a, f), this.drawFooter(d, b, a, f)
                            }
                        }
                    }
                })
            ...
            b.exports = function(a) {
                ...
                c.elements.arc = {
                    ...
                    inRange: function(a, c) {
                        var d = this._view;
                        if (d) {
                            for (var e = b.getAngleFromPoint(d, {
                                    x: a,
                                    y: c
            ...
            b.exports = function(a) {
                ...
                a.defaults.global.elements.line = {
                    ...
                    draw: function() {
                        function a(a, b) {
                            var c = b._view;
                            !0 === b._view.steppedLine ? (i.lineTo(b._view.x, a._view.y), i.lineTo(b._view.x, b._view.y)) : 0 === b._view.tension ? i.lineTo(c.x, c.y) : i.bezierCurveTo(a._view.controlPointNextX, a._view.controlPointNextY, c.controlPointPreviousX, c.controlPointPreviousY, c.x, c.y)
                        }
                        var d = this,
                            e = d._view,
                            f = e.spanGaps,
                            ...
                            i = d._chart.ctx;
                        i.save();
                        var j = d._children.slice(),
                            k = -1;
                        h && j.length && j.push(j[0]);
                        var l, m, n, o;
                        if (j.length && e.fill) {
                            for (i.beginPath(), l = 0; l < j.length; ++l) m = j[l], n = b.previousItem(j, l), o = m._view, 0 === l ? (h ? i.moveTo(g.x, g.y) : i.moveTo(o.x, g), o.skip || (k = l, i.lineTo(o.x, o.y))) : (n = -1 === k ? n : j[k], o.skip ? f || k !== l - 1 || (h ? i.lineTo(g.x, g.y) : i.lineTo(n._view.x, g)) : (k !== l - 1 ? f && -1 !== k ? a(n, m) : h ? i.lineTo(o.x, o.y) : (i.lineTo(o.x, g), i.lineTo(o.x, o.y)) : a(n, m), k = l));
                            h || i.lineTo(j[k]._view.x, g), i.fillStyle = e.backgroundColor || c.defaultColor, i.closePath(), i.fill()
                        }
                        var p = c.elements.line;
                        for (i.lineCap = e.borderCapStyle || p.borderCapStyle, i.setLineDash && i.setLineDash(e.borderDash || p.borderDash), i.lineDashOffset = e.borderDashOffset || p.borderDashOffset, i.lineJoin = e.borderJoinStyle || p.borderJoinStyle, i.lineWidth = e.borderWidth || p.borderWidth, i.strokeStyle = e.borderColor || c.defaultColor, i.beginPath(), k = -1, l = 0; l < j.length; ++l) m = j[l], n = b.previousItem(j, l), o = m._view, 0 === l ? o.skip || (i.moveTo(o.x, o.y), k = l) : (n = -1 === k ? n : j[k], o.skip || (k !== l - 1 && !f || -1 === k ? i.moveTo(o.x, o.y) : a(n, m), k = l));
                        i.stroke(), i.restore()
                    }
                })
            }
                ...
                c.elements.point = {
                    ...
                    draw: function() {
                        var e = this._view,
                            ...
                            i = e.x,
                            j = e.y;
                        e.skip || (f.strokeStyle = e.borderColor || d, f.lineWidth = b.getValueOrDefault(e.borderWidth, c.elements.point.borderWidth), f.fillStyle = e.backgroundColor || d, a.canvasHelpers.drawPoint(f, g, h, i, j))
                    }
                })
            }
        }, {}],
                ...
                var b = a.helpers,
                    ...
                    d = a.Scale.extend({
                        getLabels: function() {
                            ...
                            return (this.isHorizontal() ? a.xLabels : a.yLabels) || a.labels
                        },
                        determineDataLimits: function() {
                            var a = this,
                                c = a.getLabels();
                            a.minIndex = 0, a.maxIndex = c.length - 1;
                            var d;
                            void 0 !== a.options.ticks.min && (d = b.indexOf(c, a.options.ticks.min), a.minIndex = -1 !== d ? d : a.minIndex), void 0 !== a.options.ticks.max && (d = b.indexOf(c, a.options.ticks.max), a.maxIndex = -1 !== d ? d : a.maxIndex), a.min = c[a.minIndex], a.max = c[a.maxIndex]
                        },
                        buildTicks: function() {
                            var a = this,
                                b = a.getLabels();
                        ...
                        getPixelForValue: function(a, b, c, d) {
                            ...
                            if (e.isHorizontal()) {
                                var i = e.width - (e.paddingLeft + e.paddingRight),
                                    j = i / f,
                                    k = j * (b - e.minIndex) + e.paddingLeft;
                                return e.options.gridLines.offsetGridLines && d && (k += j / 2), e.left + Math.round(k)
                            }
                            var l = e.height - (e.paddingTop + e.paddingBottom),
                                m = l / f,
                                n = m * (b - e.minIndex) + e.paddingTop;
                            return e.options.gridLines.offsetGridLines && d && (n += m / 2), e.top + Math.round(n)
                        },
                        getPixelForTick: function(a, b) {
                        ...
                        getValueForPixel: function(a) {
                            var b = this,
                                c = Math.max(b.ticks.length - (b.options.gridLines.offsetGridLines ? 0 : 1), 1),
                                d = b.isHorizontal(),
                                e = d ? b.width - (b.paddingLeft + b.paddingRight) : b.height - (b.paddingTop + b.paddingBottom),
                                f = e / c;
                            return a -= d ? b.left : b.top, b.options.gridLines.offsetGridLines && (a -= f / 2), a -= d ? b.paddingLeft : b.paddingTop, a <= 0 ? 0 : Math.round(a / f)
                        },
                        getBasePixel: function() {
                            return this.bottom
                        }
                    ...
                    d = a.LinearScaleBase.extend({
                        ...
                        getPixelForValue: function(a) {
                            var b, c, d = this,
                                ...
                                h = +d.getRightValue(a),
                                i = d.end - g;
                            return d.isHorizontal() ? (c = d.width - (e + d.paddingRight), b = d.left + c / i * (h - g), Math.round(b + e)) : (c = d.height - (d.paddingTop + f), b = d.bottom - f - c / i * (h - g), Math.round(b))
                        },
                        getValueForPixel: function(a) {
                            var b = this,
                                c = b.isHorizontal(),
            ...
            b.exports = function(a) {
                ...
                a.LinearScaleBase = a.Scale.extend({
                    ...
                    buildTicks: function() {
                        ...
                        g = Math.max(2, g);
                        var h;
                        if (e.fixedStepSize && e.fixedStepSize > 0 || e.stepSize && e.stepSize > 0) h = f(e.fixedStepSize, e.stepSize);
                        else {
                            var i = b.niceNum(a.max - a.min, !1);
                            h = b.niceNum(i / (g - 1), !0)
                        }
                        var j = Math.floor(a.min / h) * h,
                            k = Math.ceil(a.max / h) * h,
                            l = (k - j) / h;
                        l = b.almostEquals(l, Math.round(l), h / 1e3) ? Math.round(l) : Math.ceil(l), d.push(void 0 !== e.min ? e.min : j);
                        for (var m = 1; m < l; ++m) d.push(j + m * h);
                        d.push(void 0 !== e.max ? e.max : k), a.handleDirectionalChanges(), a.max = b.max(d), a.min = b.min(d), e.reverse ? (d.reverse(), a.start = a.max, a.end = a.min) : (a.start = a.min, a.end = a.max)
                    },
                    convertTicksToLabels: function() {
                        var b = this;
                    ...
                    d = a.Scale.extend({
                        ...
                        getPixelForValue: function(a) {
                            var c, d, e = this,
                                f = e.start,
                                g = +e.getRightValue(a),
                                h = b.log10(e.end) - b.log10(f),
                                i = e.paddingTop,
                                j = e.paddingBottom,
                                k = e.paddingLeft;
                            return e.isHorizontal() ? 0 === g ? d = e.left + k : (c = e.width - (k + e.paddingRight), d = e.left + c / h * (b.log10(g) - b.log10(f)), d += k) : 0 === g ? d = e.top + i : (c = e.height - (i + j), d = e.bottom - j - c / h * (b.log10(g) - b.log10(f))), d
                        },
                        getValueForPixel: function(a) {
                            var c, d, e = this,
                    ...
                    e = a.LinearScaleBase.extend({
                        ...
                        fit: function() {
                            var a, d, e, f, g, h, i, j, k, l, m, n, o = this.options.pointLabels,
                                ...
                                u = this.width,
                                v = 0;
                            for (this.ctx.font = s, d = 0; d < this.getValueCount(); d++) {
                                a = this.getPointPosition(d, t),
                                    e = this.ctx.measureText(this.pointLabels[d] ? this.pointLabels[d] : "").width + 5;
                                var w = this.getIndexAngle(d) + Math.PI / 2,
                                    x = 360 * w / (2 * Math.PI) % 360;
                                0 === x || 180 === x ? (f = e / 2, a.x + f > u && (u = a.x + f, g = d), a.x - f < v && (v = a.x - f, i = d)) : x < 180 ? a.x + e > u && (u = a.x + e, g = d) : a.x - e < v && (v = a.x - e, i = d)
                            }
                        ...
                        getIndexAngle: function(a) {
                            var b = 2 * Math.PI / this.getValueCount(),
                                c = this.chart.options && this.chart.options.startAngle ? this.chart.options.startAngle : 0,
                                d = c * Math.PI * 2 / 360;
                            return a * b - Math.PI / 2 + d
                        },
                            ...
                            if (d.display) {
                                ...
                                if (b.each(a.ticks, function(g, h) {
                                    ...
                                    for (var o = a.getDistanceFromCenterForValue(d.reverse ? a.min : a.max), p = i(h.fontSize, c.defaultFontSize), q = i(h.fontStyle, c.defaultFontStyle), r = i(h.fontFamily, c.defaultFontFamily), s = b.fontString(p, q, r), t = a.getValueCount() - 1; t >= 0; t--) {
                                        ...
                                        var x = a.pointLabels,
                                            y = this.getIndexAngle(t) + Math.PI / 2,
                                            z = 360 * y / (2 * Math.PI) % 360;
                                        j.textAlign = 0 === z || 180 === z ? "center" : z < 180 ? "left" : "right", j.textBaseline = 90 === z || 270 === z ? "middle" : z > 270 || z < 90 ? "bottom" : "top", j.fillText(x[t] ? x[t] : "", v.x, v.y)
                                    }
                                }
                            }
                        }
                ...
                var b = a.helpers,
                    ...
                    f = a.Scale.extend({
                        ...
                        getLabelMoment: function(a, b) {
                            return void 0 !== this.labelMoments[a] ? this.labelMoments[a][b] : null
                        },
                        getMomentStartOf: function(a) {
                            var b = this;
                            return "week" === b.options.time.unit && !1 !== b.options.time.isoWeekday ? a.clone().startOf("isoWeek").isoWeekday(b.options.time.isoWeekday) : a.clone().startOf(b.tickUnit)
                        },
                        determineDataLimits: function() {
                            var a = this;
                            a.labelMoments = [];
                            var c = [];
                            a.chart.data.labels && a.chart.data.labels.length > 0 ? (b.each(a.chart.data.labels, function(b) {
                                var d = a.parseTime(b);
                                d.isValid() && (a.options.time.round && d.startOf(a.options.time.round), c.push(d))
                                ...
                                "object" == typeof e.data[0] && null !== e.data[0] ? b.each(e.data, function(b) {
                                    var c = a.parseTime(a.getRightValue(b));
                                    c.isValid() && (a.options.time.round && c.startOf(a.options.time.round), g.push(c), h && (a.firstTick = null !== a.firstTick ? d.min(a.firstTick, c) : c, a.lastTick = null !== a.lastTick ? d.max(a.lastTick, c) : c))
                        ...
                        buildTicks: function() {
                            var d = this;
                            d.ctx.save();
                            var e = b.getValueOrDefault(d.options.ticks.fontSize, a.defaults.global.defaultFontSize),
                                f = b.getValueOrDefault(d.options.ticks.fontStyle, a.defaults.global.defaultFontStyle),
                                g = b.getValueOrDefault(d.options.ticks.fontFamily, a.defaults.global.defaultFontFamily),
                                h = b.fontString(e, f, g);
                            if (d.ctx.font = h, d.ticks = [], d.unitScale = 1, d.scaleSizeInUnits = 0, d.options.time.unit) d.tickUnit = d.options.time.unit || "day", d.displayFormat = d.options.time.displayFormats[d.tickUnit], d.scaleSizeInUnits = d.lastTick.diff(d.firstTick, d.tickUnit, !0), d.unitScale = b.getValueOrDefault(d.options.time.unitStepSize, 1);
                            else {
                                var i = d.isHorizontal() ? d.width - (d.paddingLeft + d.paddingRight) : d.height - (d.paddingTop + d.paddingBottom),
                                    j = d.tickFormatFunction(d.firstTick, 0, []),
                                    k = d.ctx.measureText(j).width;
                                k = k * Math.cos(b.toRadians(d.options.ticks.maxRotation)) + e * Math.sin(b.toRadians(d.options.ticks.maxRotation));
                                var l = i / k;
                                d.tickUnit = "millisecond", d.scaleSizeInUnits = d.lastTick.diff(d.firstTick, d.tickUnit, !0), d.displayFormat = d.options.time.displayFormats[d.tickUnit];
                                for (var m = 0, n = c.units[m]; m < c.units.length;) {
                                    if (d.unitScale = 1, b.isArray(n.steps) && Math.ceil(d.scaleSizeInUnits / l) < b.max(n.steps)) {
                                        for (var o = 0; o < n.steps.length; ++o)
                                            if (n.steps[o] >= Math.ceil(d.scaleSizeInUnits / l)) {
                                                d.unitScale = b.getValueOrDefault(d.options.time.unitStepSize, n.steps[o]);
                                                break
                                            } break
                                    }
                                    if (!1 === n.maxStep || Math.ceil(d.scaleSizeInUnits / l) < n.maxStep) {
                                        d.unitScale = b.getValueOrDefault(d.options.time.unitStepSize, Math.ceil(d.scaleSizeInUnits / l));
                                        break
                                    }++m, n = c.units[m], d.tickUnit = n.name;
                                    var p = d.firstTick.diff(d.getMomentStartOf(d.firstTick), d.tickUnit, !0),
                                        q = d.getMomentStartOf(d.lastTick.clone().add(1, d.tickUnit)).diff(d.lastTick, d.tickUnit, !0);
                                    d.scaleSizeInUnits = d.lastTick.diff(d.firstTick, d.tickUnit, !0) + p + q, d.displayFormat = d.options.time.displayFormats[n.name]
                                }
                            }
                            var r;
                            if (d.options.time.min ? r = d.getMomentStartOf(d.firstTick) : (d.firstTick = d.getMomentStartOf(d.firstTick), r = d.firstTick), !d.options.time.max) {
                                var s = d.getMomentStartOf(d.lastTick),
                                    t = s.diff(d.lastTick, d.tickUnit, !0);
                                t < 0 ? d.lastTick = d.getMomentStartOf(d.lastTick.add(1, d.tickUnit)) : t >= 0 && (d.lastTick = s), d.scaleSizeInUnits = d.lastTick.diff(d.firstTick, d.tickUnit, !0)
                            }
                            d.smallestLabelSeparation = d.width, b.each(d.chart.data.datasets, function(a, b) {
                                for (var c = 1; c < d.labelMoments[b].length; c++) d.smallestLabelSeparation = Math.min(d.smallestLabelSeparation, d.labelMoments[b][c].diff(d.labelMoments[b][c - 1], d.tickUnit, !0))
                            }, d), d.options.time.displayFormat && (d.displayFormat = d.options.time.displayFormat), d.ticks.push(d.firstTick.clone());
                            for (var u = 1; u <= d.scaleSizeInUnits; ++u) {
                                var v = r.clone().add(u, d.tickUnit);
                                if (d.options.time.max && v.diff(d.lastTick, d.tickUnit, !0) >= 0) break;
                                u % d.unitScale == 0 && d.ticks.push(v)
                            }
                            0 === d.ticks[d.ticks.length - 1].diff(d.lastTick, d.tickUnit) && 0 !== d.scaleSizeInUnits || (d.options.time.max ? (d.ticks.push(d.lastTick.clone()), d.scaleSizeInUnits = d.lastTick.diff(d.ticks[0], d.tickUnit, !0)) : (d.ticks.push(d.lastTick.clone()), d.scaleSizeInUnits = d.lastTick.diff(d.firstTick, d.tickUnit, !0))), d.ctx.restore()
                        },
                        getLabelForIndex: function(a, b) {
                            var c = this,
                        ...
                        getPixelForValue: function(a, b, c) {
                            var e = this;
                            a && a.isValid || (a = d(e.getRightValue(a)));
                            var f = a && a.isValid && a.isValid() ? a : e.getLabelMoment(c, b);
                            if (f) {
                                var g = f.diff(e.firstTick, e.tickUnit, !0),
                                    h = 0 !== g ? g / e.scaleSizeInUnits : g;
                                if (e.isHorizontal()) {
                                    var i = e.width - (e.paddingLeft + e.paddingRight),
                                        j = i * h + e.paddingLeft;
